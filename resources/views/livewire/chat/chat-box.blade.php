    ...
    <div class="flex flex-col h-full overflow-y-scroll border-b grow">
        ...
        <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b">
            <div class="flex items-center w-full gap-2 px-2 lg:px-4 md:gap-5">
                ...
                {{-- avatar --}}
                <div class="shrink-0">
                    <x-avatar class="h-9 w-9 lg:w-11 lg:h-11" src="https://source.unsplash.com/500x500?face-{{$selectedConversation->getReceiver()->id}}" />
                </div>

                <h6 class="font-bold truncate">{{$selectedConversation->getReceiver()->name}} ({{$selectedConversation->getReceiver()->email}})</h6>
            </div>
        </header>
        ...
        >
            @if ($loadedMessages)
                ...
                >
                    ...
                    >
                        <x-avatar src="https://source.unsplash.com/500x500?face-{{$selectedConversation->getReceiver()->id}}" />
                    </div>
